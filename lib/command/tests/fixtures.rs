...
//! [`Category`](dol_command::Category) and [`TargetKind`](dol_command::TargetKind),
//! then asserts:
//!
...
use dol_command::capabilities::CapabilityTag;
use dol_command::operation::{
...
fn opaque_schema_binding_emits_opaque_schema_tag() {
    use dol_command::target::SchemaBinding;
    let op: Operation = Insert {
...
fn acl_policy_create_emits_policy_kind() {
    use dol_command::operation::{PolicyOp, PolicyScope, StructuralVerb};
...
fn acl_mask_create_emits_mask_kind() {
    use dol_command::operation::{MaskOp, StructuralVerb};
    use smallvec::smallvec;
...
fn acl_audit_create_emits_audit_kind() {
    use dol_command::operation::{AuditEvent, AuditOp, AuditSink, StructuralVerb};
