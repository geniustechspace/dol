//! # `dol-diag` — structured diagnostics
//!
//! Every DOL crate that validates user input (`dol-check`, `dol-wire`,
...
//!
//! The catalogue of built-in codes lives in [`code`]. Downstream crates may
//! mint their own codes by passing a `&'static str`.
