...
//! | `diag`       | `dol-diag`                     | Diagnostic model + code catalogue.                         |
...
//! - `iot-min` — minimal IoT-edge slice (types + IR + stream + postcard wire).
//!
//! ## Universal serde
//!
...
#[cfg(feature = "arena")]
pub use dol_arena as arena;

#[cfg(feature = "span")]
pub use dol_span as span;

#[cfg(feature = "diag")]
pub use dol_diag as diag;
