...
use dol_ir::{Backend, BackendError, RenderedOutput, Statement, StorageOp, StorageOutput};
...
mod tests {
    use super::*;
    use dol_builder::storage::{GetObjectBuilder, ListObjectsBuilder, PutObjectBuilder};
