...
//!             dol_builder::definition::DefineModelBuilder::new("users")
...
pub use registry::{AppliedMigration, InMemoryRegistry, MigrationRegistry, MIGRATION_HISTORY};
pub use runner::{
    MigrationRunner, MigrationState, MigrationStatus, RenderedMigration, RenderedStep,
};
pub use schema_diff::{
    create_model_step, diff_models, diff_to_steps, drop_model_step, field_to_field_def,
    FieldSnapshot, ModelSnapshot,
};
...
///             "users",
///             vec![dol_ir::AlterAction::AddField(
...
///         vec![MigrationStep::alter_model(
///             "users",
///             vec![dol_ir::AlterAction::DropField("profile".into())]
///         )]
///     }
/// }
/// ```
...
// ===========================================================================
// Test helpers — reusable test fixtures for migration tests
// ===========================================================================

#[cfg(test)]
pub(crate) mod test_helpers {
    use super::*;
    use dol_builder::DefineModelBuilder;
    use dol_ir::definition::{DefineIndexIR, FieldDef};
    use dol_ir::ModelRef;
    use dol_model::FieldType;
