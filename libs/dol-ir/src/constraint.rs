//! Constraint types for schema definitions.
//!
//! These types define how schema-level constraints (foreign keys, unique,
//! check, primary key) are represented. Both `&'static str`-based
//! (compile-time) and owned `String`-based (runtime/DDL) variants are provided.
