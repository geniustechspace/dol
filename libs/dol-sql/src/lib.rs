...
impl SqlBackend {
    ...
    pub fn render_query(&self, ir: &Query) -> Result<SqlOutput, BackendError> {
        render::render_query_ir(ir, &self.dialect)
    }
    pub fn render_insert(&self, ir: &Insert) -> Result<SqlOutput, BackendError> {
        render::render_insert_ir(ir, &self.dialect)
    }
    pub fn render_insert_select(&self, ir: &InsertSelect) -> Result<SqlOutput, BackendError> {
        render::render_insert_select_ir(ir, &self.dialect)
    }
    pub fn render_update(&self, ir: &Update) -> Result<SqlOutput, BackendError> {
        render::render_update_ir(ir, &self.dialect)
    }
    pub fn render_remove(&self, ir: &Remove) -> Result<SqlOutput, BackendError> {
        render::render_remove_ir(ir, &self.dialect)
    }
    pub fn render_upsert(&self, ir: &Upsert) -> Result<SqlOutput, BackendError> {
        render::render_upsert_ir(ir, &self.dialect)
    }
    pub fn render_define_entity(&self, ir: &DefineEntity) -> Result<SqlOutput, BackendError> {
        render::render_define_entity_ir(ir, &self.dialect)
    }
    pub fn render_alter_entity(&self, ir: &AlterEntity) -> Result<SqlOutput, BackendError> {
        render::render_alter_entity_ir(ir, &self.dialect)
    }
    pub fn render_drop_entity(&self, ir: &DropEntity) -> Result<SqlOutput, BackendError> {
        render::render_drop_entity_ir(ir, &self.dialect)
    }
    pub fn render_define_index(&self, ir: &DefineIndex) -> Result<SqlOutput, BackendError> {
        render::render_define_index_ir(ir, &self.dialect)
    }
    pub fn render_compound(&self, ir: &CompoundQuery) -> Result<SqlOutput, BackendError> {
        render::render_compound_query_ir(ir, &self.dialect)
    }
    pub fn render_drop_index(&self, ir: &DropIndex) -> Result<SqlOutput, BackendError> {
        render::render_drop_index_ir(ir, &self.dialect)
    }
    pub fn render_grant(&self, ir: &Grant) -> Result<SqlOutput, BackendError> {
        render::render_grant_ir(ir)
    }
    pub fn render_revoke(&self, ir: &Revoke) -> Result<SqlOutput, BackendError> {
        render::render_revoke_ir(ir)
    }
    pub fn render_transaction(&self, ir: &Transaction) -> Result<SqlOutput, BackendError> {
        render::render_transaction_ir(ir, &self.dialect)
    }
    pub fn render_define_type(&self, ir: &DefineType) -> Result<SqlOutput, BackendError> {
        render::render_define_type_ir(ir, &self.dialect)
    }
    pub fn render_drop_type(&self, ir: &DropType) -> Result<SqlOutput, BackendError> {
        render::render_drop_type_ir(ir, &self.dialect)
    }
    pub fn render_define_policy(&self, ir: &DefinePolicy) -> Result<SqlOutput, BackendError> {
