...
use crate::query::{CompoundQueryIR, JoinIR, JoinType, LockMode, OffsetLimit, QueryIR, SetOpKind};
use crate::storage::{
...
fn object_source_from_expr() {
    let src = ObjectSource::FromExpr(dol_expr::Expr::Identifier("col".to_string()));
